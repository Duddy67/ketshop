...
(function($) {
  ...
  $(window).load(function() {
    ...
    let recipientType = $('#jform_recipient_type').val();
    let conditionType = $('#jform_condition_type').val();
    let priceRuleType = $('#jform_type').val();
    let targetType = $('#jform_target_type').val();
    ...
    $('#jform_target_type').change( function() { $.fn.changeTargetType($('#jform_target_type').val()); });
    $('#jform_recipient_type').change( function() { GETTER.recipient.removeItems(); });
    $('#jform_condition_type').change( function() { $.fn.changeConditionType($('#jform_condition_type').val()); });
    //
  ...
  $.fn.createLinkToModal = function(dynamicItemType, idNb) {
    ...
    switch($('#jform_'+dynamicItemType+'_type').val()) {
      case 'product':
	view = 'products';
  ...
  $.fn.changePriceruleType = function(type) {
    ...
    // cart
      ...
      $.fn.changeConditionType($('#jform_condition_type').val());
    }

    // Sets the target fields.
    $.fn.switchTargetOptions(type);
    $.fn.changeTargetType($('#jform_target_type').val());
  }
  ...
  $.fn.changeTargetType = function(type) {
    ...
    if(priceRuleType == 'catalog' && type == 'product') {
      $('#jform_all_variants_target').parent().parent().css({'visibility':'visible','display':'block'});
    }
    else {
      $('#jform_all_variants_target').parent().parent().css({'visibility':'hidden','display':'none'});
    }
  }
  ...
  $.fn.changeConditionType = function(type) {
    ...
    if(type == 'product_qty') {
      $('#jform_all_variants_condition').parent().parent().css({'visibility':'visible','display':'block'});
    }
    else {
      $('#jform_all_variants_condition').parent().parent().css({'visibility':'hidden','display':'none'});
    }
  }
  ...
  $.fn.switchTargetOptions = function(priceRuleType) {
    ...
    $('#jform_target_type > option').each(function() {
    ...
    $('#jform_target_type').trigger('liszt:updated');
  }
  ...
  populateConditionItem = function(idNb, data) {
	...
	options += '<option value="'+value+'" '+selected+'>'+optionValues[key]+'</option>';
      ...
      if($('#jform_condition_type').val() == 'product_cat_amount') {
	valueType = 'amount'; 
