...
(function($) {
  ...
  $(window).load(function() {
    ...
    $('#jform_weight_type').change( function() { $.fn.switchWeightType(); });
    $.fn.switchWeightType();
  });
  ...
  $.fn.switchWeightType = function() {
    if($('#jform_weight_type').val() == 'normal') {
      $('#jform_volumetric_ratio').parent().parent().css({'visibility':'hidden','display':'none'}); 
      $('#jform_weight_unit').parent().parent().css({'visibility':'visible','display':'block'}); 
    }
    else {
      $('#jform_volumetric_ratio').parent().parent().css({'visibility':'visible','display':'block'}); 
      $('#jform_weight_unit').parent().parent().css({'visibility':'hidden','display':'none'}); 
    }
  }
