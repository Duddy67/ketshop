...
(function($) {
  ...
  $.fn.getUrlQuery = function() {
    ...
    $('[id^="base_price_"]').each(function() {
      ...
      var priceWithTax = $('#price_with_tax_'+ids).val();
      ...
      urlQuery.products.push({'ids':ids, 'base_price':basePrice,
			      'quantity':quantity, 'tax_rate':taxRate,
			      'catid':catid, 'name':name,
			      'variant_name':variantName,
			      'code':code, 'price_with_tax':priceWithTax,
