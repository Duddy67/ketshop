  ...
  <?php else : ?>
	...
	<th width="1%" class="nowrap hidden-phone">
	  ...
	  <?php else : //item->type != cart ?>
	    ...
	    <?php else : ?>
		<?php for($j = 0; $j < count($item->targets); $j++) : // Displays target titles. ?>
		  <?php echo $this->escape($item->targets[$j]); ?>
		      <?php if($j + 1 < count($item->targets)) : // Separates target titles with coma. ?>
			<?php echo ', '; ?>
		      <?php endif; ?>
		<?php endfor; ?>
	    <?php endif; ?>
	  ...
	  <?php else : ?>
	      <?php for($j = 0; $j < count($item->recipients); $j++) : // Displays recipient titles. ?>
		<?php echo $this->escape($item->recipients[$j]); ?>
		    <?php if($j + 1 < count($item->recipients)) : // Separates recipient titles with coma. ?>
		      <?php echo ', '; ?>
		    <?php endif; ?>
	      <?php endfor; ?>
	  <?php endif; ?>
