...
<form action="<?php echo JRoute::_('index.php?option=com_ketshop&view=pricerules&layout=modal&tmpl=component&function='.$function);?>" method="post" name="adminForm" id="adminForm">
  ...
  <?php else : ?>
	...
	<tr>
	  <th class="title">
		  <?php echo JHtml::_('grid.sort', 'COM_KETSHOP_HEADING_NAME', 'pr.name', $listDirn, $listOrder); ?>
	  </th>
	  <th width="15%">
		  <?php echo JHtml::_('grid.sort', 'JGRID_HEADING_CREATED_BY', 'user', $listDirn, $listOrder); ?>
	  </th>
	  <th width="15%" class="center nowrap">
		  <?php echo JHtml::_('grid.sort', 'JDATE', 'pr.created', $listDirn, $listOrder); ?>
	  </th>
	  <th width="1%" class="center nowrap">
		  <?php echo JHtml::_('grid.sort', 'JGRID_HEADING_ID', 'pr.id', $listDirn, $listOrder); ?>
	  </th>
	</tr>
      </thead>
      <tfoot>
