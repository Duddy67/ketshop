...
class KetshopViewTranslation extends JViewLegacy
{
  protected $item;
  protected $form;
  protected $state;
  ...
  protected function addToolBar() 
  {
    ...
    JToolBarHelper::title($isNew ? JText::_('COM_KETSHOP_NEW_TRANSLATION') : JText::_('COM_KETSHOP_EDIT_TRANSLATION'), 'pencil-2');
	...
	if($canDo->get('core.edit') || ($canDo->get('core.edit.own') && $this->item->created_by == $userId)) {
      ...
      if($canDo->get('core.create')) {
	JToolBarHelper::save2copy('translation.save2copy');
      }
    }
