...
// Check only against component permission as translation items have no categories.
...
?>
  ...
  <?php else : ?>
	...
	<th>
	  <?php echo JHtml::_('searchtools.sort', 'COM_KETSHOP_HEADING_TITLE', 't.name', $listDirn, $listOrder); ?>
	</th>
