...
class KetshopViewManufacturers extends JViewLegacy
{
  protected $items;
  protected $state;
  ...
  protected function addToolBar() 
  {
    ...
    //      the manufacturer items have no categories.
    ...
    if($canDo->get('core.edit.state')) {
      ...
      JToolBarHelper::divider();
      JToolBarHelper::archiveList('manufacturers.archive','JTOOLBAR_ARCHIVE');
