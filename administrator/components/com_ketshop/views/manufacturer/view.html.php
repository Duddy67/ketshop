...
class KetshopViewManufacturer extends JViewLegacy
{
  protected $item;
  protected $form;
  protected $state;
  ...
  protected function addToolBar() 
  {
    ...
    JToolBarHelper::title($isNew ? JText::_('COM_KETSHOP_NEW_MANUFACTURER') : JText::_('COM_KETSHOP_EDIT_MANUFACTURER'), 'pencil-2');

    if($isNew) {
      // Check the "create" permission for the new records.
      if($canDo->get('core.create')) {
	JToolBarHelper::apply('manufacturer.apply', 'JTOOLBAR_APPLY');
	JToolBarHelper::save('manufacturer.save', 'JTOOLBAR_SAVE');
	JToolBarHelper::custom('manufacturer.save2new', 'save-new.png', 'save-new_f2.png', 'JTOOLBAR_SAVE_AND_NEW', false);
      }
    }
    else {
    ...
    JToolBarHelper::cancel('manufacturer.cancel', 'JTOOLBAR_CANCEL');
  }
