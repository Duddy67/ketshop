...
class KetshopViewTax extends JViewLegacy
{
  protected $item;
  protected $form;
  protected $state;
  ...
  protected function addToolBar() 
  {
    ...
    JToolBarHelper::title($isNew ? JText::_('COM_KETSHOP_NEW_TAX') : JText::_('COM_KETSHOP_EDIT_TAX'), 'pencil-2');
	...
	JToolBarHelper::custom('tax.save2new', 'save-new.png', 'save-new_f2.png', 'JTOOLBAR_SAVE_AND_NEW', false);
      }
    }
    else {
	...
	if($canDo->get('core.edit') || ($canDo->get('core.edit.own') && $this->item->created_by == $userId)) {
      ...
      if($canDo->get('core.create')) {
	JToolBarHelper::save2copy('tax.save2copy');
      }
    }
