...
// Gets the tag of the current admin language.
$langTag = JFactory::getLanguage()->getTag();
?>


<form action="<?php echo JRoute::_('index.php?option=com_ketshop&view=countries');?>" method="post" name="adminForm" id="adminForm">
...
?>
  ...
  <?php else : ?>
	...
	<th width="5%">
	  <?php echo JHtml::_('searchtools.sort', 'COM_KETSHOP_HEADING_NUMERIC', 'c.numerical', $listDirn, $listOrder); ?>
	</th>
	...
	<th width="1%" class="nowrap hidden-phone">
      ...
      $canEdit = $user->authorise('core.edit','com_ketshop.country.'.$item->id);
      $canEditOwn = $user->authorise('core.edit.own', 'com_ketshop.country.'.$item->id) && $item->created_by == $userId;
      $canCheckin = $user->authorise('core.manage','com_checkin') || $item->checked_out == $userId || $item->checked_out == 0;
      $canChange = ($user->authorise('core.edit.state','com_ketshop.country.'.$item->id) && $canCheckin) || $canEditOwn; 
      ?>
