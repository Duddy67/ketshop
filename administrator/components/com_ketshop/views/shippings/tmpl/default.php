...
?>
  ...
  <?php else : ?>
	...
	<th width="1%" class="nowrap hidden-phone">
      ...
      // Sets the shipping weight unit. In case of volumetric weight type, weight is always expressed in kg.
      $weightUnit = ($item->weight_type == 'normal') ? $item->weight_unit : 'kg';
      ?>
