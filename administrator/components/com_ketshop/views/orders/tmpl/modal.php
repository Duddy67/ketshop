...
<form action="<?php echo JRoute::_('index.php?option=com_popsy&view=bottles&layout=modal&tmpl=component&function='.$function);?>" method="post" name="adminForm" id="adminForm">
