...
class KetshopViewCurrencies extends JViewLegacy
{
  protected $items;
  protected $state;
  ...
  protected function addToolBar() 
  {
    ...
    JToolBarHelper::title(JText::_('COM_KETSHOP_CURRENCIES_TITLE'), 'shop-coin-dollar');

    // Get the allowed actions list
    $canDo = KetshopHelper::getActions();

    // N.B: We check the user permissions only against the component since 
    //      the currency items have no categories.
