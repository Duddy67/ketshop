...
class KetshopModelCoupons extends JModelList
{
  /**
   * Constructor.
   *
  ...
  protected function getListQuery()
  {
    ...
    $query->select($this->getState('list.select', 'c.id, c.name, c.created, c.published,c.code,'.
				   'c.created_by, c.checked_out, c.checked_out_time'));

    $query->from('#__ketshop_coupon AS c');
