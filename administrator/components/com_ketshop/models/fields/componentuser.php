...
class JFormFieldComponentuser extends JFormFieldList
{
  ...
  protected $exceptions = array('pricerule' => 'price_rule','paymentmode' => 'payment_mode');
  ...
  public function getOptions()
  {
    ...
    preg_match('#^com_ketshop\.([a-zA-Z0-9_-]+)(?:\.modal)?\.filter$#', $this->form->getName(), $matches);
    $itemName = $matches[1];
    ...
    $options = KetshopHelper::getUsers($itemName);
