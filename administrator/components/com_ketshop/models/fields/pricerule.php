...
class JFormFieldModal_Pricerule extends JFormField
{
  ...
  protected function getInput()
  {
    ...
    $script[] = '	function selectPricerule_'.$this->id.'(id, title) {';
    ...
    if($allowClear && !$scriptClear) {
	    ...
	    $script[] = '	function clearPricerule(id) {';
    ...
    $html = array();
    $link = 'index.php?option=com_ketshop&amp;view=pricerules&amp;layout=modal&amp;tmpl=component'.$modalOption.'&amp;function=selectPricerule_'.$this->id; 
    ...
    if($allowClear) {
      $html[] = '<button id="'.$this->id.'_clear" class="btn'.($value ? '' : ' hidden').'" onclick="return clearPricerule(\''.$this->id.'\')"><span class="icon-remove"></span> ' . JText::_('JCLEAR') . '</button>';
    }
