...
class KetshopModelCountries extends JModelList
{
  ...
  protected function getListQuery()
  {
    ...
    $query->select($this->getState('list.select', 'c.id, c.numerical, c.created, c.alpha_2, c.alpha_3, c.published, c.continent_code,'.
				   'c.created_by, c.checked_out, c.checked_out_time, c.lang_var, c.'.$this->countryName));
    ...
    // Filter by country name or alpha 3 search.
