...
<div class="icons">
  <?php if($canEdit) : ?>
    <div class="btn-group pull-right">
      ...
      <?php // Product the actions class is deprecated. Use dropdown-menu instead. ?>
      <ul class="dropdown-menu">
	<?php if($canEdit) :
	    // First check if the product is checked out by a different user
	  ...
	  ?>
	   ...
	   <?php else : 
	      ...
	      $url = 'index.php?option=com_ketshop&task=product.edit&p_id='.$item->id.'&return='.base64_encode($uri);
	      ?>
	      <li class="edit-icon"><a href="<?php echo JRoute::_($url); ?>"><span class="icon-edit"></span>
				     <?php echo JText::_('COM_KETSHOP_EDIT'); ?></a>
	      </li>
	  <?php endif; ?>
	<?php endif; ?>
      </ul>
