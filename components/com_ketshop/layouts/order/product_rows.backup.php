...
<?php foreach($products as $key => $product) : //List the products of the cart.
      ...
      $unitSalePrice = $product['price_with_tax']; 
  ...
  ?>
	...
	<?php echo $variantName; ?>
		...
		<div  class="info-row small">
		  ...
		  <?php if($layout == 'order_admin' && $canEdit) : // ?>
		    <input class="unit-price" type="text" name="base_price_<?php echo $product['id']; ?>_<?php echo $product['var_id']; ?>"
			   id="base_price_<?php echo $product['id']; ?>_<?php echo $product['var_id']; ?>"
	...
	<?php  if($displayData['tax_method'] == 'excl_tax') {
		 ...
		 $inclTaxResult = UtilityHelper::roundNumber(UtilityHelper::getPriceWithTax($sum, $taxRate), $displayData['rounding_rule'], $displayData['digits_precision']);
	...
	<?php if($canEdit) : //Order can be updated. ?>
	  <a class="btn remove-product" id="<?php echo $product['id'].'_'.$product['var_id']; ?>" href="#"><span class="icon-shop-bin"></a> 
	   ...
	   <input type="hidden" name="price_with_tax_<?php echo $product['id']; ?>_<?php echo $product['var_id']; ?>"
		  id="price_with_tax_<?php echo $product['id']; ?>_<?php echo $product['var_id']; ?>"
		  value="<?php echo $product['price_with_tax']; ?>" />
