...
class CategoriesControllerCategories extends JControllerAdmin
{
	...
	public function publish()
	{
	  ...
	  if(!empty($cid)) {
	    ...
	    if(($task == 'trash' || $task == 'archive') && !KetshopHelper::checkMainCategories($cid)) {
	      $this->setRedirect(JRoute::_('index.php?option=com_categories&view=categories&extension=com_ketshop', false));
	      return false;
	    }
	  }
